...
protected:
     ...
     * @example Вариации_параметров: одинаковыми параметрами будут считаться параметры вида a + b ^ c и b ^ c + a, однако a + (b ^ c) и (c ^ b) + a будут считаться разными параметрами
     * */
...
public:
     ...
     * @example Константное_выражение: true && -(23 * 0x0FA)
